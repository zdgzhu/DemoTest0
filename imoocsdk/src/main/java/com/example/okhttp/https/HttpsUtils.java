package com.example.okhttp.https;
...
//这里面有对指定证书的信任，和对所有证书的信任，
//可以去参考  鸿洋的 https的完全解析
public class HttpsUtils {
    ...
    public static SSLSocketFactory initSSLSocketFactory() {
        ...
        try {
            //通过上下文来初始化 sslContext  这个算法有两者，一个是SSL,一个是TSL，
            //这里需要根据服务器来选择，如果服务器是用SSL，那么这里就需要用SSL，需要与服务器保持一致
