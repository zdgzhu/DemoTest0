...
public class CommonDialog extends Dialog {
    ...
    private TextView signalBtnComfirm;
    ...
    public CommonDialog(Context context, String titleMsg, String contentMsg, String confirmText,
                        DialogClickListener confirmListener)
    {
        this(context, titleMsg, contentMsg, confirmText, null, Utils.px2dip(context, 260), confirmListener, null);
    }
    ...
    {
        this(context, msg, contentMsg, confirmText, cancelText, Utils.px2dip(context, 260), confirmClick, null);
    }


    public CommonDialog(Context context, String msg, String contentMsg, String confirmText, String cancelText,
                        int dialogWidth, DialogClickListener confirmClick, DialogClickListener cancleClick) {

        super(context, R.style.Base_Theme_AppCompat_Dialog);
        initDialogStyle(msg, contentMsg, confirmText, cancelText, dialogWidth, confirmClick, cancleClick);

    }

    private void initDialogStyle(String msg, String contentMsg, String confirmText, final String cancelText,
                                 int dialogWidth, final DialogClickListener confirmClick, final DialogClickListener cancleClick) {
        ...
        if (cancelText == null) { //只有一个按钮的界面
            layout1.setVisibility(View.GONE);
            layout2.setVisibility(View.VISIBLE);
            signalBtnComfirm = (TextView) findChildViewById(R.id.signal_confirm_btn);
            signalBtnComfirm.setText(confirmText);
            signalBtnComfirm.setOnClickListener(new View.OnClickListener() {
                @Override
    ...
    public void setPositiveButtonColor(int color) {
        signalBtnComfirm.setTextColor(color);
    }
