...
import com.example.network.mina.ConnectionManager;
import com.example.network.mina.MinaReceiver;
...
public class MessageFragment  extends BaseFragment  implements View.OnClickListener{
    ...
    private void handleMessage(Intent intent) {
        ...
        mData = (MinaModel) GsonUtils.fromJson(message, MinaModel.class);
        //要改成三个界面都更新
        if (mData != null) {
